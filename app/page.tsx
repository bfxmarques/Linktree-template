...
export default function Home() {
  return (
    <main className="min-h-screen md:max-w-2xl flex flex-col justify-center mx-auto items-center p-10">
      ...
      <LinkButton href="https://www.instagram.com/paulohenrik84?igsh=cms1c3p6Y21kejBz&utm_source=qr">
        Instagram
      </LinkButton>

      <LinkButton href="https://wa.me/5515991156279?text=Ol%C3%A1,%20tudo%20bem%20?%20Gostaria%20de%20saber%20mais%20sobre%20a%20venda%20de%20energia.">
        Whatsapp
      </LinkButton>
